...
(async () => {
    ...
    const testData = await excelService.readExcel("tests/data/testDataBooking.xlsx", "list-booking");

    const outputPath = path.resolve(__dirname, '../tests/json/testDataBookingList.json');
